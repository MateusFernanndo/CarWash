...
public class CarServicesValidatorTest
{
    ...
    [Fact] //it will force the error on date
    public void Error_Date_Future()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().ContainSingle().And.Contain(c => c.ErrorMessage.Equals(ResourceErrorMessages.DATE_CANNOT_BE_IN_THE_FUTURE));
    }
